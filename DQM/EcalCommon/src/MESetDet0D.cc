...
namespace ecaldqm
{
  ...
  void
  MESetDet0D::fill(EcalDQMSetupObjects const edso, DetId const& _id, double _value, double, double)
  {
    if(!active_) return;
  ...
  void
  MESetDet0D::fill(EcalDQMSetupObjects const edso, EcalElectronicsId const& _id, double _value, double, double)
  {
    if(!active_) return;
  ...
  void
  MESetDet0D::fill(EcalDQMSetupObjects const edso, int _dcctccid, double _value, double, double)
  {
    if(!active_) return;
  ...
  double
  MESetDet0D::getBinContent(EcalDQMSetupObjects const edso, DetId const& _id, int) const
  {
    if(!active_) return 0.;
  ...
  double
  MESetDet0D::getBinContent(EcalDQMSetupObjects const edso, EcalElectronicsId const& _id, int) const
  {
    if(!active_) return 0.;
  ...
  double
  MESetDet0D::getBinContent(EcalDQMSetupObjects const edso, int _dcctccid, int) const
  {
    if(!active_) return 0.;
  ...
  void
  MESetDet0D::reset(EcalElectronicsMapping const *electronicsMap, double _value/* = 0.*/, double, double)
  {
